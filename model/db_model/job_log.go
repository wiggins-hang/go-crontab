...
type JobLog struct {
	...
	PlanTime     int64  `gorm:"column:plan_time;type:int(12);default:0;comment:计划开始时间;NOT NULL" json:"planTime"`
	ScheduleTime int64  `gorm:"column:schedule_time;type:int(12);default:0;comment:实际调度时间;NOT NULL" json:"scheduleTime"`
	StartTime    int64  `gorm:"column:start_time;type:int(12);comment:任务执行开始时间;NOT NULL" json:"startTime"`
	EndTime      int64  `gorm:"column:end_time;type:int(12);default:0;comment:任务执行结束时间;NOT NULL" json:"endTime"`
}
